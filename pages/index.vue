...
export default {
  ...
  methods: {
    async getMovies() {
      const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=2a355c1f5ca071092567ea19f2c75ac2&language=en-US&page=1')
    ...
    async searchMovies () {
      const data = axios.get(`https://api.themoviedb.org/3/search/movie?api_key=2a355c1f5ca071092567ea19f2c75ac2&language=en-US&page=1&query=${this.searchInput}`)
      const result = await data
      result.data.results.forEach((movie) => {
